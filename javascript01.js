 ...
 */
 ...
 function drawCenter() {
     ...
     canvasContext.fillStyle = "#F8F8FF";
     canvasContext.strokeStyle = "#F8F8FF";
...
function connection(){
 ...
 function drawEverything()   { 
    ...
    canvasContext.strokeStyle = "red";
    canvasContext.fillText("Rychlost v perihéliu, aféliu, daném okamžiku", 30, 300);
    //canvasContext.fillStyle = "white";

    canvasContext.beginPath();
    canvasContext.moveTo(30, 315);
    canvasContext.lineTo(30+vp, 315);
    canvasContext.moveTo(30, 335);
    canvasContext.lineTo(30+va, 335);
    if(mouseDown==0 || Math.sqrt( Math.pow(pointX - x_p,2) + Math.pow(pointY -y_p,2) )>5*radius){

        if(mouseDown==0 || podm > Math.abs(  (x_p-xs)*40/(a*a) + (y_p-ys)*40/(b*b))){
            canvasContext.moveTo(30, 355);
            canvasContext.lineTo(30+vmagn, 355);
        }
    }
    canvasContext.closePath();
    canvasContext.fill();
    canvasContext.stroke();
    canvasContext.fillText("vp", 10, 320);
    canvasContext.fillText("va", 10, 340);
    canvasContext.fillText("v", 10, 360);
    canvasContext.fill();

    // NUMERICKÁ EXCENTRICITA NA ÚSEČCE
    canvasContext.fillStyle = "white";
    canvasContext.strokeStyle = "red";
    canvasContext.fillText("Numerická excentricita", 30, 380);
    canvasContext.fillText("ε", 10, 400);
    canvasContext.fillText("0", 25, 400);
    canvasContext.fillText("0.8", 165, 400);
    canvasContext.beginPath();
    canvasContext.moveTo(40, 395);
    canvasContext.lineTo(40+150*eps, 395);
    canvasContext.closePath();
    canvasContext.stroke();
    canvasContext.fill();
